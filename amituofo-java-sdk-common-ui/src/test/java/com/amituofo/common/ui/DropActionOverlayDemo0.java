 ...
 */
public class DropActionOverlayDemo0 extends JFrame {
...
//		table.setTransferHandler(new SourceTransferHandler());
		if (isLeft) {
			leftTable = table;
			leftModel = model;
			// 添加示例数据
		...
		setupDropOverlay(table, scrollPane, layeredPane);
	...
	private void setupDropOverlay(JTable table, JScrollPane scrollPane, JLayeredPane layeredPane) {
		// 创建 DropActionOverlay
		DropActionOverlay0 dropOverlay = new DropActionOverlay0(scrollPane, layeredPane);
...
//		});
	 ...
	 */
	private void handleDrop(DropActionOverlay0.TransferData transferData, DropActionOverlay0.DropAction action, JTable targetTable) {
		try {
	 ...
	 * 处理文件拖放
	 */
	private void handleFileDrop(java.util.List<File> files, DropActionOverlay0.DropAction action, JTable targetTable) {
	 ...
	 */
	private void handleTableDrop(DropActionOverlay0.TransferData transferData, DropActionOverlay0.DropAction action, JTable targetTable) {
		try {
			// 获取拖放的数据
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			DropActionOverlayDemo0 frame = new DropActionOverlayDemo0();
