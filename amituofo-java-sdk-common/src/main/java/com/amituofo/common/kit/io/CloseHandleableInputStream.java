...
public class CloseHandleableInputStream extends FilterInputStream implements IOAbortable {
	private IOCloseListener ioCloseListener;
	private boolean closed = false;

	public CloseHandleableInputStream(InputStream in, IOCloseListener ioCloseListener) {
		super(in);
